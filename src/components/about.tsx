  ...
  return (
    <section id="about">
      <article className=" flex flex-col md:flex-row items-center justify-between">
        <div>
          <h3 className="md:text-5xl text-4xl font-bold">I am a...</h3>
          <AnimatedRoles />
        </div>
      ...
      <article className="md:py-10">
        <h3 className="md:text-5xl text-4xl font-bold py-5">I love what I do.</h3>
      ...
      <article className="scroll-section padded py-10">
        <div className="scroll-container">
          <pre className="md:flex text-center justify-center text-3xl md:text-4xl lg:text-5xl font-sans font-bold">
          ...
          <div className="flex justify-center">
            <span className="text-center text-xs md:text-xl py-2">*since November 2024, data tracked and retrieved with <a
