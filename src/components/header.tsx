        ...
        <header className="flex items-center sticky top-0 z-50 justify-between p-4 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-zinc-100 dark:border-zinc-900 shadow-sm px-5 md:px-15 lg:px-25 transition-colors duration-300">
            ...
            <div className="flex items-center gap-4 md:gap-6">
                <nav className="flex gap-4 md:gap-6 text-zinc-600 dark:text-zinc-300">
                    ...
                    <Link to="/#projects" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-medium font-semibold">
                        Projects
                    </Link>
                    <Link to="/#experience" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-medium font-semibold">
                        Experience
                    </Link>
                    <Link to="/#contact" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-medium font-semibold">
                        Contact
                    </Link>
                </nav>
